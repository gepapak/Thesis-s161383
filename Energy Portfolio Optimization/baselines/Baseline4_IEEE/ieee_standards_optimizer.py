...
class IEEEStandardsOptimizer:
    ...
    def __init__(
        self,
        config: Optional[IEEEComplianceConfig] = None,
        initial_budget: float = 8e8 / 0.145,
        ...
        self.dkk_to_usd_rate = float(dkk_to_usd_rate)
    ...
    def get_summary(self) -> Dict[str, Any]:
        ...
        summary = {
            ...
            'final_portfolio_value': self.current_budget * self.dkk_to_usd_rate,
            'initial_portfolio_value': self.initial_budget * self.dkk_to_usd_rate,
            'distribution_adjusted_final_value_usd': self.current_budget * self.dkk_to_usd_rate,
            'total_distributions_usd': 0.0,
            'distribution_adjusted_evaluation': True,
            'reported_nav_total_return': portfolio_return,
            'reported_nav_final_portfolio_value': self.current_budget * self.dkk_to_usd_rate,
            'reported_nav_initial_portfolio_value': self.initial_budget * self.dkk_to_usd_rate,
            'reported_nav_sharpe_ratio': 0.0,
            'reported_nav_max_drawdown': 0.0,
            'volatility': 0.0,
            'sharpe_ratio': 0.0,
            'max_drawdown': 0.0,
