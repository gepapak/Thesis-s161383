...
from baseline_common import add_common_summary_fields, load_baseline_economic_config
...
class IEEEBaselineRunner:
    ...
    def __init__(self, data_path: Optional[str] = None, output_dir: str = "results", seed: int = 42):
        """
        ...
        # Initialize IEEE standards optimizer from the current project economics.
        self.optimizer = IEEEStandardsOptimizer(
            self.ieee_config,
            self.econ_cfg.initial_budget_dkk,
            dkk_to_usd_rate=self.econ_cfg.dkk_to_usd_rate,
        )
    ...
    def run_evaluation(self, max_timesteps: int = 10000) -> Dict[str, Any]:
        ...
        for t in range(max_timesteps):
            ...
            if t % 1000 == 0 or t == max_timesteps - 1:
                ...
                portfolio_value_usd = result['portfolio_value'] * self.econ_cfg.dkk_to_usd_rate
    ...
    def save_results(self):
        ...
        add_common_summary_fields(summary, method="IEEE Standards Compliance Diagnostic")
        summary_path = os.path.join(self.output_dir, "summary_metrics.json")
        with open(summary_path, 'w') as f:
            json.dump(summary, f, indent=2, default=str)
        print(f"Summary metrics saved to: {summary_path}")

        summary_alias_path = os.path.join(self.output_dir, "summary.json")
        with open(summary_alias_path, 'w') as f:
            json.dump(summary, f, indent=2, default=str)
        print(f"Summary also saved to: {summary_alias_path}")
    ...
    def get_final_metrics(self) -> Dict[str, Any]:
        ...
        add_common_summary_fields(final_metrics, method="IEEE Standards Compliance Diagnostic")
...
def main():
    ...
    runner = IEEEBaselineRunner(args.data_path, args.output_dir, seed=args.seed)
