def karijadi_model(new_data, i, look_back, data_partition, cap, target, return_model=False):
    ...
    if return_model:
        return models[0]  # just return the first model for export
    else:
