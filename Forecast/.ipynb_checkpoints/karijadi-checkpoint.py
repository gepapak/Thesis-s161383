def ceemdan_model(new_data, i, look_back, data_partition, cap):
    ...
    return pd.DataFrame(summed_pred_test_inv), pd.DataFrame(summed_pred_train_inv), pd.DataFrame(actual_y_test_inv)